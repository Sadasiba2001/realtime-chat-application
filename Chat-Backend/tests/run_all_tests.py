...
def run():
    ...
    total_passed = (53 if backend_success else 0) + (25 if frontend_success else 0)
    total_count = 78
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Backend Unit & Integration** | Django TestCase & Channels | 53 | {'53' if backend_success else '0'} | {'✅ PASSED' if backend_success else '❌ FAILED'} | {backend_time}s |
