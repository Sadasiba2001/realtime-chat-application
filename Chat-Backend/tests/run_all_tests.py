...
def run():
    ...
    total_passed = (136 if backend_success else 0) + (29 if frontend_success else 0)
    total_count = 165
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Backend Unit & Integration** | Django TestCase & Channels | 136 | {'136' if backend_success else '0'} | {'✅ PASSED' if backend_success else '❌ FAILED'} | {backend_time}s |
| **Frontend Unit & Component** | Vitest + Happy DOM | 29 | {'29' if frontend_success else '0'} | {'✅ PASSED' if frontend_success else '❌ FAILED'} | {frontend_time}s |
