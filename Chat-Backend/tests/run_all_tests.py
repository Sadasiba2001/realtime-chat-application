...
def run():
    ...
    total_passed = (133 if backend_success else 0) + (29 if frontend_success else 0)
    total_count = 162
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Backend Unit & Integration** | Django TestCase & Channels | 133 | {'133' if backend_success else '0'} | {'✅ PASSED' if backend_success else '❌ FAILED'} | {backend_time}s |
