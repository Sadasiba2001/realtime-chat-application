      ...
      <div className="space-y-1.5">
        ...
        <div className="relative group">
          ...
          <input
            ...
            className="w-full pl-10 sm:pl-11 pr-4 py-2.5 sm:py-3 text-xs sm:text-sm bg-white/10 dark:bg-[#251545]/70 text-white placeholder-purple-300/40 rounded-full border border-purple-400/25 outline-hidden focus:scale-[1.01] focus:ring-2 focus:ring-purple-400/70 focus:border-purple-400 focus:shadow-[0_0_20px_rgba(168,85,247,0.35)] transition-all duration-200 shadow-inner"
          />
        </div>
      </div>
